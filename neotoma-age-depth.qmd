...
RADIOCARBON CALIBRATION CURVE IMAGE HERE
...
The `BchronCalibrate()` example above uses three arguments:

- uncalibrated ages (the estimated date returned from the lab)
- a standard deviation associated with each of the ages
- a calibration curve associated with each of the dates

Take 5 minutes to experiment with a few different ages and standard deviations, and check the function documentation for different calibration curves and try the southern hemisphere calibration.
